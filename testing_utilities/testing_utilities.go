...
func (u *PositiveTestUtilities) ResetFakeUI() {
	u.FakeUI = fakeTerm.NewFakeUI()
}
...
func (u *PositiveTestUtilities) SetJMESQueries(interface{}) error {
	return nil
}

func (u *PositiveTestUtilities) SetTableHeaderOrder([]string) {}

func (u *PositiveTestUtilities) SetOperationMetadata(interface{}) error {
	return nil
}
...
func (u *PositiveTestUtilities) Verbose(s string) {
	u.LastThingSaid = s
}

func (u *PositiveTestUtilities) Print(s string) {
	u.LastThingSaid = s
}

func (u *PositiveTestUtilities) Warn(s string) {}
...
func (u *PositiveTestUtilities) IsPrivateEndpointEnabled() bool {
	return false
}
...
func (u *PositiveTestUtilities) ValidateJSON(input, fields string) ([]string, error) {
	return []string{}, nil
}
...
func (u *NegativeTestUtilities) SetJMESQueries(interface{}) error {
	return nil
}

func (u *NegativeTestUtilities) SetTableHeaderOrder([]string) {}

func (u *NegativeTestUtilities) SetOperationMetadata(interface{}) error {
	return nil
}
...
func (u *NegativeTestUtilities) Verbose(string) {}

func (u *NegativeTestUtilities) Print(string) {}

func (u *NegativeTestUtilities) Warn(s string) {}
...
func (u *NegativeTestUtilities) IsPrivateEndpointEnabled() bool {
	return false
}
...
func (u *NegativeTestUtilities) ValidateJSON(input, fields string) ([]string, error) {
	return []string{"#.extra.field"}, nil
}
